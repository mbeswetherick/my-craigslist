...
function addChartDiv(maximum,minimum,average,range)
{
  ...
  newDiv = document.createElement("img");
	newDiv.setAttribute("style","margin-left:35%");
  newDiv.setAttribute("src", "https://chart.googleapis.com/chart?chtt=Cost Breakdown&chxt=x,y&chxr=1,0,"+maximum+"&cht=bvs&chd=s:cEj9U&chco=F2C2E1&chs=400x400&chbh=a,30,30&chxl=0:|Maximum|Minimum|Average|Range&chd=t:"+maximum+","+minimum+","+average+","+range);
