...
function addChartDiv()
{
  ...
  newDiv = document.createElement("img");
	newDiv.setAttribute("src", "https://chart.googleapis.com/chart?chs=250x100&chd=t:60,40&cht=p3&chl=Hello|World");


  // add the newly created element and it's content into the DOM
	 //<img src="https://chart.googleapis.com/chart?chs=250x100&amp;chd=t:60,40&amp;cht=p3&amp;chl=Hello|World" />.
  their_div = document.getElementById("showPics");
  document.body.insertBefore(newDiv, their_div);
}
