...
function getPageContents(){
	...
	$("p").each( function (index) {
		try {
			...
			//post
			$.post("http://postbin.heroku.com/837a36b9", { date: postArray[0], price: postArray[1], url : postArray[2], title : postArray[3], location_specific : postArray[4], location_wide: postArray[5], category: postArray[6] } );
		} catch (TypeError) {}
	});
}
